...
func TestFull(t *testing.T) {
	...
	instanceName := fmt.Sprintf("test-policies-power-%s", uniqueId)
...
`
	...
	iassert.AssertMOComply(t, fmt.Sprintf("/api/v1/power/Policies/%s", moid), expectedJSONTemplate, vars)
}
